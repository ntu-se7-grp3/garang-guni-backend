...
public class ScrapDealerExceptionTest {
    ...
    void testHandleScrapDealerNotFoundException() {
        ScrapDealerNotFoundException exception = new ScrapDealerNotFoundException("Scrap dealer not found");
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleScrapDealerNotFound(exception);
